...
//Ashley Grafner
//9/11/2024
//Question 6 for Assignment 3
//Optimized by using Switch-Case Blocks and removing multiple if, if-else, etc blocks
...
void main() {
    ...
    // Map nationality code to country name using switch
    switch (nationality) {
